...
public class Principal extends JFrame {
	...
	public Principal() {
		...
		fondo.setIcon(new ImageIcon("data/escenarios/3.png"));
		labPersonaje1.setIcon(new ImageIcon("data/jackImg/derecha/nuevo/1.png"));
		labPersonaje2.setIcon(new ImageIcon("data/jackImg/izquierda/nuevo/1.png"));
...
//	}
	...
	public void pintarImagen() {
		...
		{		
			...
			{
				ImageIcon icon = new ImageIcon("data/jackImg/derecha/nuevo/"+controlImagen1+".png");
			...
			{
				ImageIcon icon = new ImageIcon("data/jackImg/izquierda/nuevo/"+controlImagen1+".png");
				labPersonaje1.setIcon(icon);
				controlImagen1++; 
				if (controlImagen1 > 6) {
					controlImagen1 = 1; 
...
//			detenerHilo();
		...
		else
		{
			...
			{
				ImageIcon icon = new ImageIcon("data/jackImg/derecha/nuevo/"+controlImagen2+".png");
			...
			{
				ImageIcon icon = new ImageIcon("data/jackImg/izquierda/nuevo/"+controlImagen2+".png");
				labPersonaje2.setIcon(icon);
				controlImagen2++; 
				if (controlImagen2 > 6) {
					controlImagen2 = 1; 
